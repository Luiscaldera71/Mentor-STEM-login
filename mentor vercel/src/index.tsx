...
// --- FIREBASE CONFIG ---
// Las credenciales ahora se cargan desde variables de entorno (archivo .env o configuración de Vercel)
...
async function init() {
  ...
  try {
    ...
    if (!firebaseConfig.apiKey) {
        ...
        errorContainer.innerHTML = `<div class="login-box" style="text-align: left;"><h3 style="color: red;">Error de Configuración</h3><p>Las variables de entorno de Firebase (<code>VITE_FIREBASE_*</code>) no están configuradas. Por favor, añádelas a tu archivo <strong>.env</strong> o en la configuración de tu proyecto en Vercel.</p></div>`;
        return;
    }
